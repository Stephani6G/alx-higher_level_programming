...
"""
rectangle.py that inherits from Base , defines arectangle
has private instance attributes width, height, x and y and super class id.
 methods area, display, str, update and to_dictionary
"""
